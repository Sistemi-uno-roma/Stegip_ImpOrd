...
Public Class frmDatiGen_old
    ...
    Private Sub cmdSalva_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSalva.Click
        With DatiGen
            ...
            .GrCod_PF = txtGrCod_PF.Text
            .GrCod_Comp = txtGrCod_Comp.Text
    ...
    Private Sub frmDatiGen_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With DatiGen
            ...
            txtGrCod_PF.Text = .GrCod_PF
            txtGrCod_Comp.Text = .GrCod_Comp
    ...
    Private Sub cmdSfogliaFileOutContab_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSfogliaFileOutANA.Click
        With SaveFileDialog1
            .Title = "File Esportazione"
            .InitialDirectory = Application.StartupPath
            .Filter = "txt files (*.txt)|*.txt"
            .ShowDialog()
            txtFilOutArt.Text = .FileName
        End With
    End Sub
    ...
    Private Sub chkDocProv_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkDocProvORV.CheckedChanged
        If chkDocProvORV.Checked Then
            chkDocProvORV.Font = New Font(chkDocProvORV.Font, FontStyle.Bold)
        Else
            chkDocProvORV.Font = New Font(chkDocProvORV.Font, FontStyle.Regular)
        End If
    End Sub
